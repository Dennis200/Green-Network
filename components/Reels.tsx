...
import { Heart, MessageCircle, Share2, MoreVertical, Music, Camera, X, Zap, RotateCcw, Check, Sparkles, Disc, Send, Flag, Ban, VolumeX, Save, ArrowRight, ArrowLeft } from 'lucide-react';
